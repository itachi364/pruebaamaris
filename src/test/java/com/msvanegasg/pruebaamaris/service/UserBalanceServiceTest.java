...
class UserBalanceServiceTest {
    ...
    void setup() {
        ...
        service = new UserBalanceService(repository, fundRepository,transactionRepository );
    }
    ...
    void suscribirAFondo_conDatosValidos_retornaDTO() {
        ...
        when(fundRepository.findById("f1"))
                .thenReturn(Optional.of(new Fund("f1", "Fondo Conservador", 100000,FundCategory.FIC)));
